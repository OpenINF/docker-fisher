...
RUN apt-get update && export DEBIAN_FRONTEND=noninteractive \
  ...
  # ****************************************************************************
  && apt-get -y install --no-install-recommends autoconf bison patch build-essential cmake pkg-config libicu-dev rustc libssl-dev libyaml-dev libreadline6-dev zlib1g-dev libcurl4-openssl-dev libgmp-dev libncurses5-dev libffi-dev libgdbm6 libgdbm-dev libdb-dev uuid-dev \
